...
Usage: python shadow-faceboook_hack.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
...
Examples:
        |
     |--------
     | python shadow-facebook_hack.py -t Victim@gmail.com -w /usr/share/wordlists/your.txt
     |--------
     | python shadow-facebook_hack.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python shadow-facebook_hack.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python shadow-facebook_hack.py -t Victim@gmail.com -s 1234567
     |--------
     | python shadow-facebook_hack.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
